...
public class SecurityConfig {
    ...
    public CorsConfigurationSource getCorsConfigurationSource(){
        ...
        configuration.setAllowedOriginPatterns(Arrays.asList("https://code-slayer1404.github.io/cricket-blog-app-frontend/","http://blogappfrontendbucket.s3-website.ap-south-1.amazonaws.com","http://localhost:[5173]"));
